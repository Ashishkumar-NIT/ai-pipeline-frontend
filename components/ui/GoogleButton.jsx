...
export function GoogleButton({ onClick, text = "Continue with Google" }) {
  return (
    <Button
      variant="outline"
      onClick={onClick}
      className="relative"
    >
        <span className="flex items-center gap-3 text-current">
            {text}
            <svg viewBox="0 0 24 24" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill="currentColor" d="M -21.484 53.529 C -21.734 52.809 -21.864 52.039 -21.864 51.239 C -21.864 50.439 -21.734 49.669 -21.484 48.949 L -21.484 45.859 L -25.464 45.859 C -26.284 47.479 -26.754 49.299 -26.754 51.239 C -26.754 53.179 -26.284 54.999 -25.464 56.619 L -21.484 53.529 Z" />
