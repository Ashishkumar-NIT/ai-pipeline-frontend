export function ImageUploadBox({ label }) {
  return (
    <div className="flex flex-col gap-2 w-full">
      <span className="text-[13px] font-semibold text-[#374151]">{label}</span>
      <button 
        type="button" 
        className="w-full flex items-center justify-center bg-[#EEF4FF] border-[1.5px] border-dashed border-[#2563EB] rounded-[12px] hover:bg-blue-50 transition-colors cursor-pointer aspect-[1.4/1] relative"
      >
