...
export function OnboardLayout({ children, heading, description, backRoute }) {
  return (
    <div className="min-h-screen bg-[#FFFFFF] flex flex-col font-sans antialiased text-[#374151]">
      ...
      <main className="flex-1 w-full max-w-[1100px] mx-auto px-[clamp(16px,3vw,48px)] py-[clamp(24px,3vw,40px)] flex flex-col md:flex-row md:justify-center md:items-start gap-8 md:gap-[clamp(24px,3vw,48px)]">
        {/* Left Side */}
