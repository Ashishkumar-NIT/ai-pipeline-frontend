        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <select
              ...
              className={`w-full appearance-none bg-[#FFFFFF] rounded-[8px] border outline-none px-4 py-3.5 text-[15px] text-[#374151] transition-shadow cursor-pointer ${isStateError ? 'border-[#EF4444]' : 'border-[#E5E7EB] focus:ring-2 focus:ring-black/10'}`}
            >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <select
              ...
              className={`w-full appearance-none rounded-[8px] border outline-none px-4 py-3.5 text-[15px] text-[#374151] transition-shadow ${!selectedState ? 'bg-[#F9FAFB] border-[#E5E7EB] cursor-not-allowed opacity-80' : isCityError ? 'bg-[#FFFFFF] border-[#EF4444]' : 'bg-[#FFFFFF] border-[#E5E7EB] focus:ring-2 focus:ring-black/10 cursor-pointer'}`}
            >
              <option value="" disabled className="text-[#9CA3AF]">select</option>
              {cities.map((city) => (
